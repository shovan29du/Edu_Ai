  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      ...
      <input
        ...
        className="w-full rounded-lg border px-4 py-2 text-sm mb-5 focus:outline-none focus:ring-2 focus:ring-teal-400 dark:bg-gray-800 dark:text-white dark:border-gray-600"
      />
